...
import Exontario from "./Exontario";
...
const Onbookings = () => {
  ...
  const filteredBookingsData = bookingsData.filter((booking) => {
    ...
    return (
      ...
      booking["MoveFrom"].toLowerCase().endsWith("on")
    );
  });
                ...
                <React.Fragment key={index}>
                  ...
                  {selectedBooking === booking && (
                    <>
                      ...
                      {renderTabContent(activeTab, selectedBooking, query, editStates, setEditStates, setSelectedBooking, generateGoogleMapsLink, handleSave)}
                      </div>
                    </>
                  )}
                </React.Fragment>

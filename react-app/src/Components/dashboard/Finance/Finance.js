          ...
          <table className="finance-table1">
            ...
            <tbody>
              <tr>
                ...
                <td>{`CA$ ${totals.completed.estimateAmount.toFixed(2)}`}</td>
                <td>{`CA$ ${totals.completed.finalAmtIncludingTax.toFixed(2)}`}</td>
                <td>{`CA$ ${totals.completed.finalAmtExcludingTax.toFixed(2)}`}</td>
              </tr>
            </tbody>
            <tbody>
              <tr>
                ...
                <td>{`CA$ ${totals.yetToComplete.estimateAmount.toFixed(2)}`}</td>
                <td>-</td>
                <td>-</td>
              </tr>
            </tbody>

...
function UserProfile({ userDetails, onClose }) {
  return (
    <div className="card">
      ...
      <p className="title">User id: {userDetails.userid}</p>
<p className="title">Role Name: {userDetails.roledetails.rolename}</p>
<p className="title">Role ID: {userDetails.roledetails.roleid}</p>
